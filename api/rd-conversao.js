...
//   RD_CONVERSION_IDENTIFIER   (opcional) identificador da conversão. Padrão: lp-diagnostico-chatgpt
//
// TODO (antes de publicar): confirmar com o time de marketing o conversion_identifier
// e as tags desta campanha. O identificador PRECISA ser diferente do da LP
// irmã (lp-diagnostico-ia), senão as duas campanhas viram uma só no relatório.
...
module.exports = async function handler(req, res) {
  ...
  const identifier = process.env.RD_CONVERSION_IDENTIFIER || "lp-diagnostico-chatgpt";
  ...
  const tags = ["diagnostico-ia", "vibe-coding", "campanha-chatgpt"];
